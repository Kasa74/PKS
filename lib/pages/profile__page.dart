...
class _ProfilePageState extends State<ProfilePage> {
  ...
  final TextEditingController fullNameController = TextEditingController(text: 'Кудрявцев Никита Дмитриевич');
  final TextEditingController groupController = TextEditingController(text: 'ЭФБО-03-22');
  final TextEditingController phoneNumberController = TextEditingController(text: '+1 234 567 89 00');
  final TextEditingController emailController = TextEditingController(text: 'antonio@mail.ru');
